...
export const MAX_FRESH_RECRUIT_POWER = 151;
...
export const DUO_BODYGUARD_ATK_BONUS_PERCENT = 10; // "Bodyguard"
export const DUO_LUCKY_AEGIS_LUCK_SHARE_PERCENT = 15; // "Lucky Aegis"
export const DUO_TWIN_FRENZY_ATK_BONUS_PERCENT = 5; // "Twin Frenzy"
export const DUO_RAMPART_DEF_BONUS_PERCENT = 5; // "Shield Wall"
export const DUO_CROWD_LUCKY_GOLD_BONUS_PERCENT = 10; // "Rowdy Crowd"
export const DUO_RECKLESS_DUO_ATK_BONUS_PERCENT = 10; // "Reckless Duo"
export const DUO_GLASS_CANNON_LUCK_BONUS_PERCENT = 15; // "Glass Cannon"
